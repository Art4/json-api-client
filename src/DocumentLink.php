...
@trigger_error(__NAMESPACE__ . '\DocumentLink is deprecated since version 0.10 and will be removed in 1.0. Use Art4\JsonApiClient\V1\DocumentLink instead', E_USER_DEPRECATED);
 ...
 */
final class DocumentLink extends AbstractElement implements DocumentLinkInterface
{
    /**
