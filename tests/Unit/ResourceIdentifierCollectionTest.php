...
class ResourceIdentifierCollectionTest extends \Art4\JsonApiClient\Tests\Fixtures\TestCase
{
    use HelperTrait;
    ...
    {
        $collection = new ResourceIdentifierCollection($this->manager, $this->createMock('Art4\JsonApiClient\AccessInterface'));
        $collection->parse([]);
