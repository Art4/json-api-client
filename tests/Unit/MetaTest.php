...
class MetaTest extends \Art4\JsonApiClient\Tests\Fixtures\TestCase
{
    use HelperTrait;
    ...
    public function testCreateWithObject()
    {
        ...
        $this->assertSame($meta->getKeys(), ['object', 'array', 'string', 'number_int', 'number_float', 'true', 'false', 'null']);

        $this->assertSame($meta->asArray(), [
        ...
        // Test full array
        $this->assertSame($meta->asArray(true), [
